...
if [[ "$MODE" == "--full" ]]; then
  ...
  printf '\nPrüfe Repo-Hygiene, Rückfall-, Release-, Sicherheits-, Restore-, Diagnose-, Song-, Profil-, Todo-, Kalender-, Prozess- und Kubuntu-Logik …\n'
  ...
  printf '\nPrüfe Laienführung, Dashboard, Fehlerhilfe, Songeditor, Songbibliothek, Profile, Todo, Kalender und Zoom in echter PySide6-Oberfläche …\n'
  export QT_QPA_PLATFORM="${QT_QPA_PLATFORM:-offscreen}"
  python3 -m unittest tests.test_layman_ux_gui tests.test_recovery_ui_gui tests.test_song_gui tests.test_song_library_gui tests.test_song_library_controls_gui tests.test_dashboard_reference_gui tests.test_zoom_controls_gui tests.test_profile_gui tests.test_todo_gui tests.test_calendar_gui || fehler=1
