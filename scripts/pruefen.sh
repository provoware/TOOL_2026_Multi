...
if [[ "$MODE" == "--full" ]]; then
  ...
  printf '\nPrüfe Rückfall-, Release-, Sicherheits-, Restore-, Diagnose-, Recovery-, Song-, Profil-, Todo-, Kalender- und Kubuntu-Abnahmelogik …\n'
