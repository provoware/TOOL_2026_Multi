...
if [[ "$MODE" == "--full" ]]; then
  ...
  printf '\nPrüfe Rückfall-, Release-, Sicherheits-, Restore-, Diagnose-, Recovery-, Song-, Profil-, Todo- und Kubuntu-Abnahmelogik …\n'
  ...
  printf '\nPrüfe Dashboard, Recovery, Songeditor, Songbibliothek, Profile, Todo und Zoom in echter PySide6-Oberfläche …\n'
  export QT_QPA_PLATFORM="${QT_QPA_PLATFORM:-offscreen}"
  python3 -m unittest tests.test_recovery_ui_gui tests.test_song_gui tests.test_song_library_gui tests.test_song_library_controls_gui tests.test_dashboard_reference_gui tests.test_zoom_controls_gui tests.test_profile_gui tests.test_todo_gui || fehler=1
